...
export const initialProducts: Product[] = [
  ...
  },
  {
    ...
    isNew: true,
    inStock: true,
    description: "Made from carefully selected golden Jowar grains, DEVAM Jowar Flour is traditionally processed to preserve its natural goodness, wholesome taste and dietary fibre.",
  ...
  },
  {
    ...
    isNew: true,
    inStock: true,
    description: "Made from carefully selected, naturally golden Makkai grains, DEVAM Makkai Flour is traditionally processed to preserve its wholesome taste.",
  ...
  },
  {
    ...
    isNew: false,
    inStock: true,
    description: "Made from carefully selected Bajri grains, DEVAM Bajri Flour is traditionally processed for rich taste and authentic Gujarati rotla.",
  ...
  },
  {
    ...
    inStock: true,
    badge: "High Calcium",
    description: "DEVAM Ragi Flour is made from 100% pure, wholesome ragi (finger millet), rich in calcium and dietary fiber.",
